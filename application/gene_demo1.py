...
from misc_util import negative_effect, summarize_ate_samples, plot_ate_samples, save_results
...
def run_example(cause_gene, target_gene):
    ...
    ate_summary_pm, ate_summary_np, ate_summary_gnpp, summary_gbf = subsample_ate(
        a, testX_hat, testX, y, negative_effect, n_post, start_size=50, n_SS=20
    )

    # Save the results
    save_results(cause_gene, target_gene, ate_summary_pm, ate_summary_np, ate_summary_gnpp, summary_gbf)
...
if __name__ == "__main__":
    run_example(cause_gene = 'FOXP3', target_gene = 'GZMH')